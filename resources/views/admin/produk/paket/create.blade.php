...
@section('title', 'Tambah Paket - Jemari Bidan')
...
<div class="max-w-3xl mx-auto">
    ...
    <form action="{{ route('admin.produk.paket.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        @csrf
        
        <div class="p-6 border-b border-slate-100">
            <h2 class="text-xl font-bold text-slate-800">Tambah Paket Baru</h2>
        </div>
        ...
        <div class="p-6 space-y-5">
            ...
            <div>
                ...
                <input type="text" name="nama" value="{{ old('nama') }}" 
                       ...
                       placeholder="Contoh: Calm Mom" required>
                @error('nama')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="durasi" value="{{ old('durasi', 60) }}" 
                           class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 outline-none transition"
                           min="1" required>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="4" 
                          ...
                          placeholder="Deskripsi lengkap paket...">{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea name="fitur" rows="5" 
                          class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 outline-none transition resize-y font-mono text-sm"
                          placeholder="Massage relaksasi&#10;Pijat perut&#10;Konsultasi postnatal">{{ old('fitur') }}</textarea>
